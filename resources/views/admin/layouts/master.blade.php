                            ...
                            <div class="col-sm-3">
                                <div class="card fun">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body me-3">
                                                <h2 class="num-text text-black font-w600">{{ $jobApplicationCount }}</h2>
                            ...
                            <div class="col-sm-3">
                                <div class="card fun">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body me-3">
                                                <h2 class="num-text text-black font-w600">{{ $activeJobCount }}</h2>
                                                <span class="fs-14">Active Jobs</span>
                                            </div>
                                            <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-sm-3">
                                <div class="card fun">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <div class="media-body me-3">
                                                <h2 class="num-text text-black font-w600">{{ $acceptedApplicationCount }}</h2>
                                                <span class="fs-14">Accepted Applications</span>
                                            </div>
