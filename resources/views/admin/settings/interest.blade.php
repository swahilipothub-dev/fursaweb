                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="w-space-no">{{ $inter->interest }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex">
                                        @if (!$inter->in_use)
                                            <form action="{{ route('deleteInterest', $inter->id) }}" method="POST" style="display: inline;">
                                                @csrf
                    ...
                    <div class="modal-content">
                       ...
                       <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="location_name">Interest Name</label>
                            <input type="text" class="form-control" name="interest" id="interest" placeholder="Enter Interest name">
                        </div>
